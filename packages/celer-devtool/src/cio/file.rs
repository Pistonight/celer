...
pub fn write_json_file(value: &serde_json::Value, file_name: &str, pretty: bool, out_errors: &mut ErrorMap) {
...
pub fn write_yaml_file(value: &serde_json::Value, file_name: &str, out_errors: &mut ErrorMap) {
...
pub fn write_file(content: String, file_name: &str, out_errors: &mut ErrorMap) {
