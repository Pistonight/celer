import { TARGET_VERSION } from "data/compile";
...
export const exampleRouteScriptPresets = {
	...
	Project: {
		...
		Authors: ["iTNTPiston"],
		Url: "itntpiston.github.io/celer?Internal=1&Id=Presets",
		Version: "v1.0.0",
		Description: "Examples of presets"
	},
	Route: [
		"(?=) Not all presets have been implemented. You can see some presets not rendered at the bottom. They will soon be supported",
		{
			"Example Presets":[
