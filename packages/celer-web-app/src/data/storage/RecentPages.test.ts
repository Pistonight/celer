import { addPageToRecents, loadRecentPages, MAX_RECENT_PAGES } from "data/storage";
// const RecentPages = require("./RecentPages.ts");

// Note that as of Jest@24, localStorage is mocked, so no changes made here
