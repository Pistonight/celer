...
export class StyleEngine<CSArray extends Array<ComputeStyle<StyleMap>>> {
	...
	public compute(sizes: AppSizes, colors: AppColors, mapDisplayMode: MapDisplayMode): ComputedStyle<CSArray> {
		let mainCss = "";
	...
	private computeCssMemoized(sizes: AppSizes, colors: AppColors,  mapDisplayMode: MapDisplayMode, docMode: RouteDocMode): string{
